...
$(document).ready(function() {
  ...
  /**
   * xz
   * @todo : hardcode this first, later use serverside to pull env
   */
  var stripe = Stripe('pk_test_51Jfg9oHXGuejMXCEMRqjrJEqsBfSjiq6rqev9JnE32IXI6ffAlmraJPlModWSRSG4oQQwteohZXN3rsZnYXiEj9Y00FGx4l5X9');
